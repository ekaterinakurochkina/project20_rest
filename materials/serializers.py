...
class SubscriptionSerializer(serializers.ModelSerializer):
    ...
    # def get_user_courses_with_subscription(self, user):
    #     """Возвращает курсы, на которые пользователь подписан."""
    #     subscriptions = Subscription.objects.filter(user=user, is_subscription=True).select_related('course')

    class Meta:
        model = Subscription
        fields = ['id', 'is_subscription', 'user', 'course']
